...
// radio button selecionado
    ...
    private void imprimir_os() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                JasperPrint print = JasperFillManager.fillReport("C:\\Users\\guilh\\Documents\\Meus Projetos\\Lab.SW_OS_System_Java\\reports\\os.jasper", filtro, conexao);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(cboOsSit, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void txtCliPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCliPesquisarKeyReleased
        // Chama método Pesquisar cliente
        pesquisar_cliente();
    ...
    private void btnOsImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsImprimirActionPerformed
        // Chamar método para imprimir a os
        imprimir_os();
